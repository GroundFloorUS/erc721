...
export type { GroundfloorNoteToken } from "./contracts/GroundfloorNoteToken";
export { GroundfloorNoteToken__factory } from "./factories/contracts/GroundfloorNoteToken__factory";
